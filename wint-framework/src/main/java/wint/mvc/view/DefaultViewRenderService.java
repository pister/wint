...
public class DefaultViewRenderService extends AbstractService implements ViewRenderService {
    ...
    private boolean useMacroLibrary = true;
    ...
    private void initViewRenderEngines() {
        if (LibUtil.isFreeMarkerExist()) {
            ...
            if (!useMacroLibrary) {
               templateEngine.setMacroLibrary(null);
            }
    ...
    public void setUseMacroLibrary(boolean useMacroLibrary) {
        this.useMacroLibrary = useMacroLibrary;
    }
}
