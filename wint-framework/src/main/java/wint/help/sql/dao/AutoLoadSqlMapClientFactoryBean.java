...
public class AutoLoadSqlMapClientFactoryBean extends SqlMapClientFactoryBean implements ApplicationContextAware {

	private static final Logger log = LoggerFactory.getLogger(AutoLoadSqlMapClientFactoryBean.class);
	...
	public AutoLoadSqlMapClientFactoryBean(SqlMapClientFactoryBean sqlMapClientFactoryBean) {
		super();
	...
	public AutoLoadSqlMapClientFactoryBean() {
		super();
	}
	...
	static class SqlMapClientProxy extends SqlMapClientImpl {
		...
		private AutoLoadSqlMapClientFactoryBean autoLoadConfigSqlMapClientFactoryBean;
		...
		public synchronized void reload() throws IOException {
			...
			uploadLocations();
			updateMappings();
			SqlMapClientImpl newSqlMapClient = autoLoadConfigSqlMapClientFactoryBean.superBuildSqlMapClient();
			this.targetSqlMapClient = newSqlMapClient;
		}

		public SqlMapClientProxy(AutoLoadSqlMapClientFactoryBean autoLoadConfigSqlMapClientFactoryBean, Resource[] configLocations, ResourceLoader resourceLoader) throws IOException {
			super(new SqlMapExecutorDelegate());
			this.autoLoadConfigSqlMapClientFactoryBean = autoLoadConfigSqlMapClientFactoryBean;
