...
public class ConvertUtil {
    ...
    private static final SmartYearMonthConvert smartYearMonthConvert = new SmartYearMonthConvert();
    ...
    public static LocalDate toLocalDate(String input, LocalDate defaultValue) {
        try {
            return smartLocalDateConvert.convertTo(input, defaultValue);
        } catch (Exception e) {
            return defaultValue;
        }
    }

    public static LocalDate toLocalDate(String input, String pattern, LocalDate defaultValue) {
        try {
            return LocalDateTimeUtil.parseDate(input, pattern);
        } catch (Exception e) {
            return defaultValue;
        }
    }
    ...
    public static LocalDateTime toLocalDateTime(String input, LocalDateTime defaultValue) {
        try {
            return smartLocalDateTimeConvert.convertTo(input, defaultValue);
        } catch (Exception e) {
            return defaultValue;
        }
    }

    public static LocalDateTime toLocalDateTime(String input, String pattern, LocalDateTime defaultValue) {
        try {
            return LocalDateTimeUtil.parseDateTime(input, pattern);
        } catch (Exception e) {
            return defaultValue;
        }
    }
    ...
    public static LocalTime toLocalTime(String input, LocalTime defaultValue) {
        try {
            return smartLocalTimeConvert.convertTo(input, defaultValue);
        } catch (Exception e) {
            return defaultValue;
        }
    }

    public static LocalTime toLocalTime(String input, String pattern, LocalTime defaultValue) {
        try {
            return LocalDateTimeUtil.parseTime(input, pattern);
        } catch (Exception e) {
            return defaultValue;
        }
    }
    ...
    public static YearMonth toYearMonth(String input, YearMonth defaultValue) {
        try {
            return smartYearMonthConvert.convertTo(input, defaultValue);
        } catch (Exception e) {
            return defaultValue;
        }
    }

    public static YearMonth toYearMonth(String input, String pattern, YearMonth defaultValue) {
        try {
            return LocalDateTimeUtil.parseYearMonth(input, pattern);
        } catch (Exception e) {
            return defaultValue;
        }
    }
