package wint.dal.ibatis.spring;
...
import wint.dal.ibatis.ext.ex.NotNullExceptionTranslator;
...
public class SqlMapClientTemplate extends JdbcAccessor implements SqlMapClientOperations {
    ...
    public SQLExceptionTranslator getExceptionTranslator() {
        return new NotNullExceptionTranslator(super.getExceptionTranslator());
    }
}
