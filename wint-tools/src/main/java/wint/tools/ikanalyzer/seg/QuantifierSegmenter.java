 ...
 * 
 */
package wint.tools.ikanalyzer.seg;

import java.util.HashSet;
import java.util.Set;

import wint.tools.ikanalyzer.Lexeme;
import wint.tools.ikanalyzer.Context;
import wint.tools.ikanalyzer.dic.Dictionary;
import wint.tools.ikanalyzer.dic.Hit;
import wint.tools.ikanalyzer.help.CharacterHelper;
...
//		AllNumberChars.addAll(RomeNumChars);
	...
	/* (non-Javadoc)
	 * @see wint.tools.ikanalyzer.ISegmenter#nextLexeme(wint.tools.ikanalyzer.IKSegmentation.Context)
	 */
