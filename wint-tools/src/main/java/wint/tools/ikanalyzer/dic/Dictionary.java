 ...
 * 
 */
package wint.tools.ikanalyzer.dic;
...
import wint.tools.ikanalyzer.cfg.Configuration;
...
public class Dictionary {
	...
	static final String BASE_PATH = "wint/tools/ikanalyzer";
	
	/*
	 * 分词器默认字典路径 
	 */
	public static final String PATH_DIC_MAIN = BASE_PATH + "/dic/main.dic";
	public static final String PATH_DIC_SURNAME = BASE_PATH +"/dic/surname.dic";
	public static final String PATH_DIC_QUANTIFIER = BASE_PATH +"/dic/quantifier.dic";
	public static final String PATH_DIC_SUFFIX = BASE_PATH +"/dic/suffix.dic";
	public static final String PATH_DIC_PREP = BASE_PATH +"/dic/preposition.dic";
	public static final String PATH_DIC_STOP = BASE_PATH + "/dic/stopword.dic";
	...
	private InputStream getDictInputStream(String name) {
		InputStream is = Dictionary.class.getResourceAsStream(name);
		if (is != null) {
			return is;
		}
		is = Dictionary.class.getClassLoader().getResourceAsStream(name); 
		return is;
	}
	...
	private void loadMainDict(){
		...
		//读取主词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_MAIN);
        if(is == null){
	...
	private void loadSurnameDict(){
		...
		//读取姓氏词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_SURNAME);
        if(is == null){
	...
	private void loadQuantifierDict(){
		...
		//读取量词词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_QUANTIFIER);
        if(is == null){
	...
	private void loadSuffixDict(){
		...
		//读取量词词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_SUFFIX);
        if(is == null){
	...
	private void loadPrepDict(){
		...
		//读取量词词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_PREP);
        if(is == null){
	...
	private void loadStopWordDict(){
		...
		//读取量词词典文件
        InputStream is = getDictInputStream(Dictionary.PATH_DIC_STOP);
        if(is == null){
