...
public abstract class WintJettyRunMojoBase extends AbstractJettyRunMojo {
    ...
    public void checkPomConfiguration () throws MojoExecutionException
    {
        ...
        try
        {
            ...
            {
                webAppSourceDirectory = new File (executedProject.getBasedir(), "src"+File.separator+"main"+File.separator+"webapp");
            ...
            throws MojoExecutionException
    {
        ...
        listeners.add(new Scanner.BulkListener()
        {
            public void filesChanged (List changes)
            {
                try
                {
                    boolean reconfigure = changes.contains(getExecutedProject().getFile().getCanonicalPath());
    ...
    private List<File> getDependencyFiles ()
    {
        ...
        for ( Iterator<Artifact> iter = getExecutedProject().getArtifacts().iterator(); iter.hasNext(); )
        {
